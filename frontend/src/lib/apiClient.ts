...
const realApi = {
  ...
  appointments: {
    types: () => apiFetch<any[]>('/api/v1/appointments/types'),
    slots: (params: any) => apiFetch<any[]>('/api/v1/appointments/slots', { params }),
    ...
    confirm: (id: string) => apiFetch<any>(`/api/v1/appointments/${id}/confirm`, { method: 'POST' }),
    counter: (id: string, body: any) => apiFetch<any>(`/api/v1/appointments/${id}/counter`, { method: 'POST', body: JSON.stringify(body) }),
    acceptCounter: (id: string) => apiFetch<any>(`/api/v1/appointments/${id}/accept-counter`, { method: 'POST' }),
    cancel: (id: string, body?: any) => apiFetch<any>(`/api/v1/appointments/${id}/cancel`, { method: 'POST', body: JSON.stringify(body ?? {}) }),
  },
  notifications: {
