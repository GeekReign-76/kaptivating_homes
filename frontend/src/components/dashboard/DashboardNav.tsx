...
import { LayoutDashboard, Users, MessageSquare, Home, FileText, Calendar, Clock, LogOut, ExternalLink, Activity, BarChart2 } from 'lucide-react';
...
const NAV = [
  ...
  { href: '/dashboard/analytics',   icon: BarChart2,       label: 'Analytics',    adminOnly: false },
